...
### Ans 4: "hey from message1" then -> "hey from Main controller" then -> "hey from message3" then -> "hey from message2"
...
### Ans 5: "hey from message3" then -> "hey from message2" then -> "hey from Main controller" then -> "hey from message1" 
